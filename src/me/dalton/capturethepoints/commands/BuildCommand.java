    ...
    public void perform() {
        ...
        if (arg.equalsIgnoreCase("create")) {
            if (ctp.getPermissions().canAccess(player, false, new String[]{"ctp.*", "ctp.admin", "ctp.admin.create"})) {
                ...
                ctp.getArenaMaster().addNewArena(new Arena(ctp, arg2, Status.CREATING, ctp.getGlobalConfigOptions().startCountDownTime, ctp.getGlobalConfigOptions().playTime)); //Create the new arena!
